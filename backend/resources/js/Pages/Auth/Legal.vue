...
<template>
    <main class="legal-page" :dir="locale === 'en' ? 'ltr' : 'rtl'" :lang="locale">
        <header class="legal-header">
            <Link class="legal-back" :href="route('login')" :view-transition="false" :aria-label="t('Back')">
