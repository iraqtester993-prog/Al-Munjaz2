...
const primaryKpis = computed(() => [
    ...
    { icon: 'team', label: 'عدد المندوبين', value: props.kpis.couriers, tint: 'var(--st-approved-tint)', color: 'var(--st-approved)' },
    { icon: 'team', label: 'عدد التجار', value: props.kpis.merchants, tint: 'var(--warning-tint)', color: 'var(--warning)' },
    { icon: 'message', label: 'رسائل OTP', value: props.kpis.otpMessages ?? 0, tint: 'var(--primary-tint)', color: 'var(--primary-strong)' },
])
...
function kpiIcon(name) {
    const paths = {
        ...
        message: 'M21 11.5a8.4 8.4 0 0 1-9 8.5 9.7 9.7 0 0 1-4-.9L3 20l1-3.4A8.4 8.4 0 0 1 3 11.5a8.5 8.5 0 0 1 9-8.5 8.5 8.5 0 0 1 9 8.5Z',
    }
    return paths[name]
}
...
@media(max-width:650px){.distribution-layout{grid-template-columns:1fr}.donut-wrap{max-width:180px;margin:auto}.financial-list{padding-inline:15px}.week-chart{gap:7px;padding-inline:0}.week-label{font-size:8.5px}.dashboard-kpis{gap:10px}.tbl th,.tbl td{padding:10px}}
