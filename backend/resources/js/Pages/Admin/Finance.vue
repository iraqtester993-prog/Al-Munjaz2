...
<template>
    <AdminShell :title="t('Finance')">
            ...
            <div class="panel finance-requests-panel">
                ...
                <div class="request-stack">
                    <article v-for="request in pendingRequests" :key="request.id" class="finance-request-card">
                        ...
                        <div class="request-card-actions"><button class="finance-btn approve" type="button" @click="openDecision(request, 'approve')">{{ t('Approve') }}</button><button class="finance-btn reject" type="button" @click="openDecision(request, 'reject')">{{ t('Reject') }}</button></div>
                    </article>
        ...
        <div v-if="activeRequest" class="finance-dialog-backdrop" @click.self="closeDecision">
