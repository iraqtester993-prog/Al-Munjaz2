...
<template>
    <SheetModal :open="open" :title="t('Privacy Policy') + ' · ' + t('Terms of Use')" fullscreen preserve-nav show-back @close="emit('close')">
